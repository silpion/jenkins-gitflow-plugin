...
public abstract class AbstractGitflowAction {
    ...
    /**
     * Returns the value for the specified parameter from the provided parameters. If the value is emtpy or contains only whitespaces, an {@link IOException} is
     * thrown (note that only an @{@link IOException} prpoperly causes a build to fail).
     *
